...
4. **テキスト禁止** — 必ず末尾に "No text, no words, no letters, no numbers, no labels." を含める
5. **1:1 アスペクト比**

#### プロンプトのテンプレート
```
Children's book illustration style. A warm, colorful scene of [場所の説明].
[Q1の内容を反映した要素].
[Q2の内容を反映した要素].
[Q3の内容を反映した要素].
[Q4の内容を反映した要素].
...
[Q6の内容を反映した要素].
[Q7の内容を反映した要素].
Soft pastel colors, friendly atmosphere, suitable for educational material.
